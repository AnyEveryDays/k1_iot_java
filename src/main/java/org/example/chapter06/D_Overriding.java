...
// == 오버라이딩(Overriding) == //
// : 자식 클래스가 부모 클래스에서 상속받은 '메서드'를 자신의 상황에 맞게 '재정의'  오버로딩은 여러개 정의
...
//    }
    ...
    //       , 부모 클래스의 메서드에서 재정의 했는지 판단

    @Override
    void exercise(){
        System.out.println("달리기도 잘하고 피구도 잘합니다");
        // 부모클래스의 달리기를 잘합니다가 아닌 자식의 고유로 덮어버려서 오버라이드 같긴하다
...
public class D_Overriding {
    public static void main(String[] args) {
        ...
        // : 메서드의 이름을 재사용 하는 방법( 다형성 - 같은 이름으로 다른 행위)
