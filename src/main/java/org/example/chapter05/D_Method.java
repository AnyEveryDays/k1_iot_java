...
// 1. 정적 메서드란?
// : static 키워드를 사용하여 정의된 메서드, 클래스명으로 직접 호출
// - static 반환타입 메서드명() {}
// - 클래스명.메서드명();
...
class Operator {
    ...
    static int subtract(int a, int b) {
         int result = a - b; // 비 static 필드 'a'는 static 컨텐스트에서 참조할 수 없다
         return result;
...
public class D_Method {
    public static void main(String[] args) {
        ...
        System.out.println(operator.multiply(10,20)); // 200 (인스턴스 필드10 * 인지 20)
