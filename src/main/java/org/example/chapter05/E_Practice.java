...
public class E_Practice {
    public static void main(String[] args) {
        BaseballPlayer player1 = new BaseballPlayer("이대형", 0.310,1);
        BaseballPlayer player2= new BaseballPlayer( "박해민", 0.314,10);
        BaseballPlayer player3 = new BaseballPlayer("이대호", 0.364,44);
        BaseballPlayer player4 = new BaseballPlayer("이승엽", 0.327,56);

        System.out.println("총 생성된 선수의 수: "+ BaseballPlayer.playerCount);
        player2.updateStatus(0.312, 24);
