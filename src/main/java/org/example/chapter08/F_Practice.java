...
abstract class MoblieApp {
    ...
    // 일반 (구현) 메서드
    void appInfo(){
        System.out.println("This is a moblie app");
    }
}
...
public class F_Practice {
    public static void main(String[] args) {
        // == 다형성 적용 == //
        // : 업캐스팅
        MoblieApp gameApp = new GameApp();
        MoblieApp socialApp = new SocialApp("Instagram");

        // 다형성 적용에 의해 공통된 메서드 호출 기능
        gameApp.execute();
        gameApp.appInfo();  // this is a moblie app (재정의 x, 부모의 행위를 출력)
