...
public class B_Exception02 {
    public static void main(String[] args) {
        ...
        //int division = 10/0; //Exception in thread "main" java.lang.ArithmeticException: / by zero
        // at org.example.chapter09.B_Exception02.main(B_Exception02.java:31)
        ...
        try {
            ...
            // 1)
            int division = 10 / 1;
            System.out.println("위에서 에러가 발생할 경우 실행 X");
