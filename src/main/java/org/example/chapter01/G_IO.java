...
public class G_IO {
    public static void main(String[] args) {
        ...
        System.out.println("안녕하세요 :)");  // ln (line) 주어진 값을 콘솔에 입력하고! 줄바꿈
        System.out.print("두 번째 수업입니다!");
        System.out.println(20240702);
        ...
        // new Scanner(입력받을 방법);
        // : 새로운 스캐너를 생겅
        // - System.in : 현재 실행되고 있는 프로그램(IDE)의 콘솔에서 입력받은 몸
        ...
        //        -nextLine()은 사용자의 입력밧을 기다리지 않고 빈 문자열(개행문자)를 담고 종료

        // 스캐너 종료 방법 //
        // 스캐너 사용 후 메모리 최적화를 위해 스캐너 종료

        iotScanner.close();
        // iotScanner 종료 이후 호출시 오류 발생 close로 닫으면 iotScanner 사용 불가
    }
}
