...
public class E_DataType {
    public static void main(String[] args) {
        /*
            ...
            cf) Stack(스택) : 기본타입의 데이터가 실제 저장 / 참조 타입의 주소값이 저장
                Heap(힙) : 참조타입의 실제 데이터가 저장되는 공간
        ...
        // short : -32,768 ~ 32767
        // int 약 2.1억 ~ 양수 2.1억
        // long 약 -2의 63제곱 ~ 약 2의 63 제곱 -1

        byte byteValue = 127;
        short shortValue = 32767;
        int intValue = 2147483647;
        long longValue = 123123123123L; // long 타입은 숫자 뒤에 알파켓 L, l써서 표기
        ...
        char grade = 'A';
        //char lastname = "이";
        //char gender = '남'; - 단일 문자 저장만 가능
        char gender = '남';

        // 1-3) 실수형: float(4) < double(8)
        // : 부동 소수점이 있는 수
        float dollar1 = 32.123f; // 데이터값 뒤에 알파벳 F,f를 사용해야한다
