...
public class C_Variable {
    public static void main(String[] args) {
        ...
        // 4) 자바의 예약어, 키워드는 변수명으로 사용 할 수 없다!
        // int if;
        // int switch;

        // +) 권장 사항
        // 변수명은 lowerCamelCase 사용을 권장
        // : 소문자로만 작성 + 연결하는 단어의 시작은 대문자로 시작
        int strawberrychococake;
        int strawberryChocoCake;

        // cf ) UpperCamelCase
        // : 대문자로 시작 + 연결하는 단어의 시작도 대문자로 시작
        int StrawberryChocoCake;
        
        // cf) lower_snake_case;
        // : 소문자로만 작성 + 연결하는 단어는 _(언더스코어)로 구분
        int strawberry_chock_cake;
