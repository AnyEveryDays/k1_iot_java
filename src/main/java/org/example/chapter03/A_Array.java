...
public class A_Array { // 클래스명 == 파일명 ( 파일명은 대문자로 시작!)
        // 코드 작성
    ...
    public static void main(String[] args) {
        ...
        // cf) 참조 자료형 - 주소값이 저장
        // : 데이터 배열이 저장된 첫 번째 메모리 주소가 저장 (인덱스 번호 0번의 주소)
        ...
        System.out.println(scores1[1]);
        System.out.println(scores1[2]);
        //System.out.println(scores1[3]); //  Array Index Out Of Bounds Execption
        ...
        // == 배열의 선언과 동시에 초기화 == //
        // : new 연산자 사용 + 직접적으로 요소를 대입하여 배열 생성 시 길이 지정을 하지 않는다
        ...
        // cf) 참조 자료형의 출력
        // : 자바에서 객체를 sout으로 출력하면 내부적으로 객체.toString() 기능을 호출 한다
        // > 모든 참조 자료형의 집합체
        String a = "안녕";
        System.out.println(a);
        System.out.println(a.toString());
        // >> String은 내부적으로 toSTring() 호출 시 실제 데이터값 자체를 반환하도록 설정
        // >> 배열, 객체는 toString() : 주소값을 문자열로 출력

        int[] arr = {1,2,3};
        char[] arr2 = {'a','b','c'};
        System.out.println(arr); // [1@28418fc
        ...
        System.out.println(fruits); //[Ljava.lang.String;@5305068a  주소값이 나온다
        fruits[0] = "사과";
        fruits[1] = "오렌지";
